export const EXPERIENCE = [
  {
    title: "Content Creator (Video + IA)",
    company: "Software Factory AI",
  ...
  },
  {
    ...
    description:
      "Edited horizontal YouTube content with dynamic cuts, transitions, and audiovisual synchronization to maintain engaging visual flow. Applied color correction and basic color grading while efficiently managing footage, assets, and project files to streamline the editing workflow.",
  },
];
